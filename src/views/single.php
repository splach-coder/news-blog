    ...
    <div class="container-fluid">
        <div class="container">
            <nav class="breadcrumb bg-transparent m-0 p-0">
                <a class="breadcrumb-item" href="#">الرئيسية</a>
                <a class="breadcrumb-item" href="#">فئات</a>
            </nav>
        </div>
    </div>
    <!-- Breadcrumb End -->
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        <img id="main-image" class="img-fluid w-100" src="img/news-700x435-2.jpg"
                            style="object-fit: cover" />
                        <div class="overlay position-relative bg-light">
                            <div class="mb-3">
                                <a href="">عمل</a>
                                <span class="px-1">/</span>
                                <span id="main-date">January 01, 2045</span>
                            </div>
                            <div id="main-news" style="width: 100%">
                    ...
                    <div class="pb-3">
                        ...
                        <div class="bg-light text-right p-4 mb-3">
                            ...
                            <div class="input-group" style="width: 100%; direction: ltr">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-primary" id="insert-email">اشتراك</button>
                                </div>
                            </div>
                        </div>
                    </div>
